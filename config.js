...
if (JSON.parse(window.localStorage.getItem("CONFIG")) == null)
...
function saveData() {
  const inputs = {
    ...
    imageBackground: document.querySelector(
      'input[name="imageBackground"]:checked'
    ),
    openInNewTab: document.querySelector('input[name="openInNewTab"]:checked'),
    twelveHourFormat: document.querySelector(
      'input[name="twelveHourFormat"]:checked'
    ),
    ...
    changeThemeByHour: document.querySelector(
      'input[name="changeThemeByHour"]:checked'
    ),
    hourDarkThemeActive: document.querySelector(
      'input[name="hourDarkThemeActive"]'
    ),
    hourDarkThemeInactive: document.querySelector(
      'input[name="hourDarkThemeInactive"]'
    ),
    changeThemeByOS: document.querySelector(
      'input[name="changeThemeByOS"]:checked'
    ),
    autoChangeTheme: document.querySelector(
      'input[name="autoChangeTheme"]:checked'
    ),
  };
  ...
  for (let input in inputs) {
    ...
    inputs[input] != null
      ? (CONFIGSaved[`${inputs[input].name}`] = toTrueOrFalse(
          inputs[input].value
        ))
      : "";
  ...
  document.querySelector(".alert").style.transform =
